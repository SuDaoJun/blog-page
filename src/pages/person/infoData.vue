    ...
    <view class="show-data">
      <u-cell-group>
        <u-cell-item title="头像">
          <u-image  slot="right-icon" width="85rpx" height="85rpx" :border-radius='8' :src='baseURL+"/blogAdmin/file/down?downId="+infoData.avatarId'></u-image>
        </u-cell-item>
        <u-cell-item title="用户名" :value='infoData.name'></u-cell-item>
        <u-cell-item title="邮箱" :value='infoData.email'></u-cell-item>
        <u-cell-item title="个性签名" :value='infoData.info || "--"'></u-cell-item>
        <u-cell-item title="修改密码"></u-cell-item>
      </u-cell-group>
    </view>
    <div class="show-btn u-p-l-40 u-p-r-40 u-m-t-60">
