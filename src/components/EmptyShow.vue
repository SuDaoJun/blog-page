<template>
  <div class="empty-show" v-show='hide' :style='{left: iconLeft}'>
    ...
    <el-image v-if='type === "img"' :src="imgUrl" :style="{width: imgWidth, height: imgHeight}">
      <div slot="error" class="image-slot">
        <i class="el-icon-picture-outline"></i>
      </div>
    </el-image>
    <div v-else-if='type === "icon"'>
      <i  :class='iconName?iconName+ " iconfont":""' :style='{fontSize: iconStyle.fontSize,color: iconStyle.color}'></i>
    </div>
    <div v-else-if='type === "slot"'>
